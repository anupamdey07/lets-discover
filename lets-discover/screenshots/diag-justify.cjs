...
const s = await page.evaluate(() => {
  ...
  return { justCont: cs.justifyContent, alignItems: cs.alignItems, flexDir: cs.flexDirection, h: cs.height, padding: cs.padding };
});
console.log('front-face computed:', JSON.stringify(s));
await browser.close();
